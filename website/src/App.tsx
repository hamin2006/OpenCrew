...
// Static (not lazy) on purpose: `updatables.ts` is a dependency-free pure
// module (type-only imports), so the sidebar badge derivation costs the App
// chunk a few lines, not the store pages' data layer.
import { countUpdatables, type UpdatableInstalledRow } from './pages/apps/updatables'
import { registryQueryFn } from './pages/apps/useAppsData'
