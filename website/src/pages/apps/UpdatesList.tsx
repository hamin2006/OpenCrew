    ...
    <div>
      ...
      <div className="space-y-2">
        {rows.map(app => {
          ...
          // Disabled while ANY update runs: this row's own in-place call, or
          // the batch (runUpdate refuses concurrent work during Update All —
          // mirroring how the Library freezes its cards' update actions).
          const busy = !!updatingAll || updatePending === app.name
          return (
            <div
              key={app.name}
