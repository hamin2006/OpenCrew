...
def test_initial_adapter_selection_is_limited_to_reviewed_backends() -> None:
    ...
    Goose, OpenCode, pi, and registry-only adapters remain described so their
    integration work can continue, but the first preview deliberately exposes
    only the four harnesses agreed for the initial rollout.
    """
