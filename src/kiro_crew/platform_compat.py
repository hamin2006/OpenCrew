...
def path_writable_by_current_user(path: str | os.PathLike) -> bool:
    ...
    "there exists a way in" rather than "the leaf looks fine". A component that cannot be
    ...
    while current not in seen:
        ...
        try:
            if stat_writable_by_current_user(os.stat(current)):
                return True
            if _ACCESS_HONOURS_EFFECTIVE_IDS and os.access(current, os.W_OK, effective_ids=True):
                return True
        except OSError:
            pass
