...
def _run_coordinator_uses_custom_home() -> bool:
    ...
    active_dir = _run_coordinator_hidden_dir()
    try:
        return not os.path.samefile(active_dir, default_dir)
    except OSError:
        # Preserve the fail-closed answer when either directory cannot be identified.
