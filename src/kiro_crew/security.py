...
def _home_dir_targets_uncached(
    home_dirs: list[str],
    roots: tuple[str, str | None, str | None, str | None] | None = None,
) -> set[str]:
    """Anchor the ``$HOME``-relative *home_dirs* entries into absolute, casefolded
    on-disk targets.

    *roots* optionally supplies the ``(home, crew_home, kiro_home, codex_home)`` anchors
    ...
    if roots is not None:
        home, crew_home, kiro_home_override, codex_home_override = roots
    else:
        home, crew_home, kiro_home_override, codex_home_override = _resolved_root_key()
...
def _resolved_root_key() -> tuple[str, str | None, str | None, str | None]:
...
def _check_sensitive_via_normalizer(command: str) -> str | None:
    ...
    _home, crew_home, kiro_home_override, codex_home_override = _resolved_root_key()
    if crew_home:
